...
CHANCE_FOR_SATISFIABLE = 50 # as a percentage

max_variable_number= 6
formulas_number=5 # has to be at least 2
max_len=5 # has to be lower than max_variable_number
...
def generate(max_variable_number, formulas_number, max_len):
    formulas = Dupa(formulas_number, max_variable_number)
    formulas.fill(max_len, max_variable_number)
    return formulas.get_list_of_lists()

abc = Dupa(formulas_number, max_variable_number)   
