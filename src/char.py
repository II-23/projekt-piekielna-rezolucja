...
class Symbol(pygame.sprite.Sprite):
    def __init__(self, size, num, pos):
        ...
        match num:
            ...
            case 0:
                self.symbol = [pygame.image.load("./assets/lub.png").convert_alpha(), pygame.image.load("./assets/minus-sign.png").convert_alpha()]
            case -1:
                self.symbol = [pygame.image.load("./assets/minus-sign.png").convert_alpha(), pygame.image.load("./assets/minus-sign.png").convert_alpha()]
        
        self.symbol[0].set_colorkey((255,255,255))
    ...
    def update(self, mouse=pygame.mouse):
        ...
        if self.state==0 and self.cursor_over_formula(mouse_pos)==True and self.clickable:
            for element in self.tab:
                element.state=1
            self.state=1'''
        if self.cursor_over_formula(mouse_pos)==True and self.state==0:
            self.state=1
...
class Set_of_formulas(pygame.sprite.Sprite):
    def __init__(self, size, pos, list):
        ...
        self.tab=[]
        self.state=0
        #self.scorescreen=Game_over_window((100,100),(200,200),1)
    ...
    def render(self, screen):
        ...
        #self.scorescreen.render(screen)
        #self.get_surface().blit(self.scorescreen.get_surface(), (0,0))
